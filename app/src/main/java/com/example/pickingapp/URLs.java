...
public class URLs {
    private static final String IP = "192.168.100.76"; // cambiará dependiendo de la IP que tenga su computadora, cuando se modifique no añadan cambios en el git pls
